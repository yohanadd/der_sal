        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {instagramReels1.map((reel) => (
              ...
              >
                <Card
                  className="group overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 md:hover:-translate-y-3 cursor-pointer bg-[#201d24] border-2 border-[#3a3640] hover:border-white"
                >
                  <div 
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors duration-300">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-white/90 rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-300 ${playingVideos[reel.id] ? 'opacity-0' : 'opacity-80'}`}>
            ...
            {filters.map((filter) => (
              ...
              >
                <Button
                  ...
                  } px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full transition-all duration-300 tracking-wide md:tracking-wider uppercase`} 
                  style={{ fontFamily: 'var(--font-posterama)', fontWeight: 800, letterSpacing: '0.03em' }}
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredItems.map((item) => (
              ...
              >
                <Card
                  className="group overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 md:hover:-translate-y-3 border-2 border-[#3a3640] hover:border-white bg-[#2d2a32] h-full flex flex-col"
                >
